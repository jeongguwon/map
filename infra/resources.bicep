...
// AcrPull built-in role, required so container apps can pull images via managed identity
...
// Placeholder image; azd replaces this with the built backend Docker image on deploy
...
// Placeholder image; azd replaces this with the built frontend Docker image on deploy
